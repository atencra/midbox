function [v_mean, coeff, projection, mtx] = mid_get_auditory_filter(files, nf, nlags)
%
%[v_mean, coeff, projection, mtx] = get_auditory_filter(fname_first, Nh, nlags, varargin)
%
