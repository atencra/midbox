...
if ( length(sprfile) == 1 )
   if ( sprfile == 1 )
      sprfile = 'C:\MATLABR2007b\work\stimuli\dmr-500flo-20000fhi-4SM-40TM-40db-44khz-10DF-15min_6_carriers_per_octave.spr';
   elseif ( sprfile == 2 )
      sprfile = 'C:\MATLABR2007b\work\stimuli\dmr-500flo-40000fhi-4SM-40TM-40db-96khz-48DF-21min_6_carriers_per_octave.spr';
   else
      error('Wrong sprfile input.');
   end
end
...
% create random spike train with 25,000 spikes
mintrig = trigger(3);
maxtrig = trigger(end-3);
spetrand = ceil( (maxtrig-mintrig) * rand(1,25000) + mintrig );
...
for i = 1:length(mid)
   ...
   % Calc similarity indices using 50,000 random spikes 
   % ----------------------------------------------------------------
