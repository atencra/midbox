function filestruct = get_rat_rippledir_detailed_mid_files(exp, location)
...
dfile = dir(['rpdtest2_v2_' num2str(exp) '_' num2str(location) '*.dat']);
...
for i = 1:length(dfile)
   ...
   location = [location str2num(file(index(3)+1:index(4)-1))];
   unitnum = [unitnum str2num(file(index(4)+1:index(5)-1))];
end
...
for i = 1:length(unitnum)
   ...
   % Get the STA files
   dfile = dir(['rpsta_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   ...
   dfile = dir(['rpx1pxpxt_sta_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   dfile = dir(['rpdtest1_v1_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   dfile = dir(['rpdtest1_v2_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID1 files - First Most Informative Dimension
   dfile = dir(['rpdtest2_v1_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID2 files - First Most Informative Dimension
   dfile = dir(['rpdtest2_v2_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID1 files - First Most Informative Dimension
   dfile = dir(['rpdbest1_v1_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID2 files - First Most Informative Dimension
   dfile = dir(['rpdbest1_v2_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID1 files - First Most Informative Dimension
   dfile = dir(['rpdbest2_v1_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   % Get the MID2 files - First Most Informative Dimension
   dfile = dir(['rpdbest2_v2_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   dfile = dir(['rpdx1x2px_pxt_1_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
   ...
   dfile = dir(['rpd_x1x2px_pxt_2_' num2str(exp) '_' num2str(location) '_' num2str(unitnum(i)) '_*.dat']);
   if ( ~isempty(dfile) & length(dfile) == 4 )
