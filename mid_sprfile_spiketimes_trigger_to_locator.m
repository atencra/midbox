...
%  tafter, tbefore         :  Evaluation delay interval for STRF(T,F), in seconds
...
function [taxis, faxis, locator, numspikes, averate, locator_ipsi] = ...
   mid_sprfile_spiketimes_trigger_to_locator(specfile, tafter, tbefore, spiketimes, trigger, fss)
...
n1 = round( tafter * Fs / DF);
n2 = round( tbefore * Fs / DF);
