function mid_dir_plot_filter_fio2d(datapath)
%mid_dir_plot_filter_fio2d
%
%    mid_dir_plot_filter_fio2d(datapath, figpath, gspath)
% 
%    mid_dir_pdf_plot_filter_fio2d(datapath, figpath) goes through 
