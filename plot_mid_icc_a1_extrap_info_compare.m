function plot_mid_icc_a1_extrap_info_compare(projinfo, infosta, infomid1, infomid2, infomid12)
%plot_mid_icc_a1_extrap_info_compare   Compare sta and mid filter information
%
% plot_mid_icc_a1_extrap_info_compare(projinfo, infosta, infomid1, infomid2, infomid12)
% -------------------------------------------------------------------
...
%
%
% info* : vectors of auditory cortex extrapolated information data.
% Usually saved in a file such as:
%
%    load *\work\auditory_cortex_extrapolated_information.mat
%
...
%                                      % I make it small just in case - may also
%                                      % want to think about excluding the data
%                                      % too.
% 
...
% Do error check here. It's not possible for infosta > infomid1, or for
% infomid1 > infomid12. If they are, that means the there wasn't enough data
% for the extrapolation procedure and the values are unstable.

index = (infosta<= infomid1) & (infomid1 <= infomid12);
infosta = infosta(index);
infomid1 = infomid1(index);
infomid2 = infomid2(index);
infomid12 = infomid12(index);

a1_sta_mid1 = 100 * infosta ./ infomid1;
mid1_contrib = 100 * infomid1 ./ infomid12;
synergy = 100 * infomid12 ./ (infomid1 + infomid2);
