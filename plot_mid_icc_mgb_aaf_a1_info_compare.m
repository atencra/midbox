function plot_mid_icc_mgb_aaf_a1_info_compare(projinfo, extrap_info, ...
ratio_sta_v1_MGB, ratio_v1_v12_MGB, ratio_sta_v1_AAF, ratio_v1_v12_AAF)
...
infodata = extrap_info;

ista_iv1_mgb = ratio_sta_v1_MGB;
iv1_iv12_mgb = ratio_v1_v12_MGB;
ista_iv1_aaf = ratio_sta_v1_AAF;
iv1_iv12_aaf = ratio_v1_v12_AAF;
...
[infosta_test, infomid1_test, infomid2_test, infomid12_test, position] = ...
...
% Now get the mgb and the aaf data

ista_iv1_mgb = 100 * ista_iv1_mgb;
iv1_iv12_mgb = 100 * iv1_iv12_mgb;

ista_iv1_aaf = 100 * ista_iv1_aaf;
iv1_iv12_aaf = 100 * iv1_iv12_aaf;


% calc_stats_for_icc_a1_info_compare(ista_iv1_icc, iv1_iv12_icc, ...
% ista_iv1_a1, iv1_iv12_a1);
% 
% bar_plots_for_icc_a1_info_compare(ista_iv1_icc, iv1_iv12_icc, ...
% ista_iv1_a1, iv1_iv12_a1);
% 
% 
% scatter_plots_for_icc_a1_info_compare(ista_icc, iv1_icc, ...
% iv2_icc, iv12_icc, ista_iv1_icc, iv2_iv1_icc, iv1_iv12_icc, ista_a1, ...
% iv1_a1, iv2_a1, iv12_a1, ista_iv1_a1, iv2_iv1_a1, iv1_iv12_a1);
% 
% cdf_plots_for_icc_a1_info_compare(ista_iv1_icc, iv1_iv12_icc, ...
% ista_iv1_a1, iv1_iv12_a1);

bar_cdf_plots_for_icc_a1_info_compare(ista_iv1_icc, iv1_iv12_icc, ...
ista_iv1_a1, iv1_iv12_a1, position, ista_iv1_mgb, iv1_iv12_mgb, ...
ista_iv1_aaf, iv1_iv12_aaf);
...
iv1_iv12_icc, ista_iv1_a1, iv1_iv12_a1, position, ista_iv1_mgb, iv1_iv12_mgb, ...
ista_iv1_aaf, iv1_iv12_aaf)

v12gain_a1 = round( 100*(iv1_iv12_a1 ./ 100).^-1 );
index = find(v12gain_a1 > 120);
fprintf('\n100 * Info(MID12) / Info(MID1)\n');
fprintf('-------------------------------------------------\n');
fprintf('AI: %.0f of %.0f, %.0f percent of neurons, have a gain > 20 percent\n', ...
length(index), length(v12gain_a1), 100*length(index)/length(v12gain_a1));


[ista_iv1_a1, index] = sort(ista_iv1_a1);
ista_iv1_a1 = ista_iv1_a1(10:end);

[iv1_iv12_a1, index] = sort(iv1_iv12_a1);
iv1_iv12_a1 = iv1_iv12_a1(10:end);


v12gain_aaf = 1./iv1_iv12_aaf * 100 * 100;
index = find(v12gain_aaf > 120);
fprintf('AAF: %.0f of %.0f, %.0f percent of neurons, have a gain > 20 percent\n', ...
length(index), length(v12gain_aaf), 100*length(index)/length(v12gain_aaf));

v12gain_mgb = 1./iv1_iv12_mgb * 100 * 100;
index = find(v12gain_mgb > 120);
fprintf('MGB: %.0f of %.0f, %.0f percent of neurons, have a gain > 20 percent\n', ...
length(index), length(v12gain_mgb), 100*length(index)/length(v12gain_mgb));

v12gain_icc = 1./iv1_iv12_icc * 100 * 100;
index = find(v12gain_icc > 120);
fprintf('ICC: %.0f of %.0f, %.0f percent of neurons, have a gain > 20 percent\n', ...
length(index), length(v12gain_icc), 100*length(index)/length(v12gain_icc));
...
[xMgb, yMgb] = cumdist(ista_iv1_mgb);
[xA1, yA1] = cumdist(ista_iv1_a1);
[xAaf, yAaf] = cumdist(ista_iv1_aaf);
...
subplot(2,2,1);
hold on;
cmap = cschemes('blues', 5);
% plot(xNonGran, yNonGran, '-', 'color', [0.6 0.6 0.6], 'linewidth', 3);
% plot(xGran, yGran, '-', 'color', [0.4 0.4 0.4], 'linewidth', 3);

plot(xIcc, yIcc, '-', 'color', cmap(1,:), 'linewidth', 2);
plot(xMgb, yMgb, '-', 'color', cmap(2,:), 'linewidth', 2);
plot(xAaf, yAaf, '-', 'color', cmap(3,:), 'linewidth', 2);
plot(xA1, yA1, '-', 'color', cmap(4,:), 'linewidth', 2);
...
[xMgb, yMgb] = cumdist(iv1_iv12_mgb);
[xA1, yA1] = cumdist(iv1_iv12_a1);
[xAaf, yAaf] = cumdist(iv1_iv12_aaf);
...
% calculate standard error for icc
se_ista_iv1_icc = std(ista_iv1_icc) / length(ista_iv1_icc);
se_iv1_iv12_icc = std(iv1_iv12_icc) / length(iv1_iv12_icc);



% calculate median ratios for mgb
md_ista_iv1_mgb = median(ista_iv1_mgb);
md_iv1_iv12_mgb = median(iv1_iv12_mgb);

% calculate Median Absolute Deviation for mgb
mad_ista_iv1_mgb = mad(ista_iv1_mgb(:), 1);
mad_iv1_iv12_mgb = mad(iv1_iv12_mgb(:), 1);

% calculate mean ratios for mgb
mn_ista_iv1_mgb = mean(ista_iv1_mgb);
mn_iv1_iv12_mgb = mean(iv1_iv12_mgb);

% calculate standard error for mgb
se_ista_iv1_mgb = std(ista_iv1_mgb) / length(ista_iv1_mgb);
se_iv1_iv12_mgb = std(iv1_iv12_mgb) / length(iv1_iv12_mgb);




% calculate median ratios for aaf
md_ista_iv1_aaf = median(ista_iv1_aaf);
md_iv1_iv12_aaf = median(iv1_iv12_aaf);

% calculate Median Absolute Deviation for aaf
mad_ista_iv1_aaf = mad(ista_iv1_aaf(:), 1);
mad_iv1_iv12_aaf = mad(iv1_iv12_aaf(:), 1);

% calculate mean ratios for aaf
mn_ista_iv1_aaf = mean(ista_iv1_aaf);
mn_iv1_iv12_aaf = mean(iv1_iv12_aaf);

% calculate standard error for aaf
se_ista_iv1_aaf = std(ista_iv1_aaf) / length(ista_iv1_aaf);
se_iv1_iv12_aaf = std(iv1_iv12_aaf) / length(iv1_iv12_aaf);
...
% calculate standard error for a1
se_ista_iv1_a1 = std(ista_iv1_a1) / length(ista_iv1_a1);
se_iv1_iv12_a1 = std(iv1_iv12_a1) / length(iv1_iv12_a1);


subplot(2,2,3);
hold on;
ytick = linspace(0, 100, 5);
hb = bar([mn_ista_iv1_icc mn_ista_iv1_mgb mn_ista_iv1_aaf mn_ista_iv1_a1]);

% plot([1 1], [mn_ista_iv1_icc mn_ista_iv1_icc+se_ista_iv1_icc], 'k-');
% plot([0.8 1.2], [mn_ista_iv1_icc+se_ista_iv1_icc mn_ista_iv1_icc+se_ista_iv1_icc], 'k-');
% 
% plot([2 2], [mn_ista_iv1_mgb mn_ista_iv1_mgb+se_ista_iv1_mgb], 'k-');
% plot([1.8 2.2], [mn_ista_iv1_mgb+se_ista_iv1_mgb mn_ista_iv1_mgb+se_ista_iv1_mgb], 'k-');
% 
% plot([3 3], [mn_ista_iv1_aaf mn_ista_iv1_aaf+se_ista_iv1_aaf], 'k-');
% plot([2.8 3.2], [mn_ista_iv1_aaf+se_ista_iv1_aaf mn_ista_iv1_aaf+se_ista_iv1_aaf], 'k-');
% 
% plot([4 4], [mn_ista_iv1_a1 mn_ista_iv1_a1+se_ista_iv1_a1], 'k-');
% plot([3.8 4.2], [mn_ista_iv1_a1+se_ista_iv1_a1 mn_ista_iv1_a1+se_ista_iv1_a1], 'k-');
...
set(gca,'xticklabel', {'ICC', 'MGB', 'AAF', 'AI'});
xlim([0 5]);
ylim([50 100]);
ylabel('Mean STA sufficiency');


subplot(2,2,4);
hb = bar([mn_iv1_iv12_icc mn_iv1_iv12_mgb mn_iv1_iv12_aaf mn_iv1_iv12_a1]);
set(hb, 'edgecolor', [0.6 0.6 0.6])
set(hb, 'facecolor', [0.6 0.6 0.6])
box off;
set(gca,'tickdir', 'out', 'ticklength', [0.025 0.025]);
