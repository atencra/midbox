function [x0train, x0test, x0train_locator, x0test_locator] = filter_nonlinearity_method_figure(locator, stimulus, params)
% mid_projection_information - stimulus projections onto STA and MIDs obtained
% from the MID code.
%
% infoextrap = mid_projection_information(locator, stimulus, params)
% ----------------------------------------------------
%
...
elseif ( nargin == 2 )
%    params.prefix = 'D:\data\MID_Inferior_Colliculus\Preliminary_IC_Results_June2008\';
%    params.location = 708;
%    params.cell = 3;
   params.prefix = 'D:\data\MID_Inferior_Colliculus\Cell_707_1_1234b\';
   params.location = 707;
   params.cell = 1;
   params.optlevel = 2;
   params.cy = 1;
...
plot_proj_prob_dist(x0train, x0train_locator); % for the nonlinearity
