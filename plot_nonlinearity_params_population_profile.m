function [options, layerstr] = plot_nonlinearity_params_population_profile(fio_params, mid)
%
% [options, layerstr] = plot_nonlinearity_params_population_profile(fio_params, mid)
%
...
%       layerbins = [200 600 1100 1500 2000];
%       centerbins = [400 850 1300 1750];
      ...
      for j = 1:(length(layerbins)-1)
         ...
         holm_data = [holm_data; temp(:) j*ones(length(temp),1)];
