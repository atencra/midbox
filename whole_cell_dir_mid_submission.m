function whole_cell_mid_submission(varargin)
...
for i = 1:length(spkfiles)
    ...
    shscriptpath = sprintf('script_%d_%d_%d_%dreps.sh', exp, site, cellnum, nTestReps);
    ...
    if ( 1 ) %~exist(shscriptpath,'file') )
        ...
        fprintf(fid_shscript, sprintf('#$ -o /netapp/home/craiga/%s/Logs\n', datadir));
        fprintf(fid_shscript, sprintf('#$ -e /netapp/home/craiga/%s/Errors\n', datadir));
